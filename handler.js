...
const messageText = `_*< مستخدم محظور />*_\n
 ▢ *Aviso:* ${messageNumber}/3
 ${user.bannedReason ? `\n▢ *Motivo:* ${user.bannedReason}` : ' ▢ *Motivo:* Sin especificar'}
 *[ ℹ️ ] إذا كنت تعتقد أن هذا خطأ ولديك دليل، فيمكنك الاتصال بمالك البوت لاستئناف الاستخدام.*`.trim();
              m.reply(messageText);
        ...
        'extendedTextMessage': {
            ...
            'contextInfo': {
                'externalAdReply': {
                    ...
                    'body': '⁨ 𝚂𝙽𝙸𝙿𝙴𝚁 𝔖⁩',
                    'thumbnail': imagen1,
                    'sourceUrl': 'https://www.egsniper.com'
                }
            }
        }
    }, aa);
